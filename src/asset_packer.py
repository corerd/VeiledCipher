...
def asset_pack(carrier_path: str, asset_file_path: str, password: str, output_package_path: str):
    """
...
def asset_unpack(package_path: str, password: str, dest_file_path: str):
    """
    ...
    try:
        ...
        print(f"SUCCESS: File successfully extracted and saved to: {dest_file_path}")
